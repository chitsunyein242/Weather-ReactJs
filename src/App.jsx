...
function App() {
  ...
  useEffect(() =>{
   ...
   const fetchData = async (city) =>{
    ...
    return (
    <>
      <div className="w-full min-vh-100 d-flex justify-content-center align-items-center flex-column bg-secondary bg-opacity-25 gap-4">
        <h1 className="text-dark fw-bold fs-1 text-uppercase mt-3">
          Weather App
        </h1>
